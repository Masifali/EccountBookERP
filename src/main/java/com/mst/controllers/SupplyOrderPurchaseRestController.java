...
import com.mst.services.SupplyOrderPurchaseService;
...
@RestController
@RequestMapping("/api/purchase/supply-order-purchase")
public class SupplyOrderPurchaseRestController {

    @Autowired
    private SupplyOrderPurchaseService supplyOrderPurchaseService;
    ...
    public ResponseEntity<?> getDropdowns() {
        ...
        return ResponseEntity.ok(supplyOrderPurchaseService.getDropdowns(orgId, compId));
    }
    ...
    public ResponseEntity<?> getNextCode() {
        ...
        int nextNo = supplyOrderPurchaseService.generateNextDocNo(orgId, compId, branchId, yearId);
    ...
    public ResponseEntity<?> getHistory(@RequestBody(required = false) Map<String, Object> bodyParams,
        ...
        List<Map<String, Object>> history = supplyOrderPurchaseService.getHistory(orgId, compId, branchId, yearId, fromDate, toDate, supplierId, fromDocNo, toDocNo, dateType);
        return ResponseEntity.ok(history);
    }

    @GetMapping("/{id}")
    public ResponseEntity<?> getById(@PathVariable("id") int id) {
        Map<String, Object> data = supplyOrderPurchaseService.getById(id);
    ...
    public ResponseEntity<?> save(@RequestBody Map<String, Object> payload) {
        ...
        Map<String, Object> res = supplyOrderPurchaseService.saveSupplyOrder(payload);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        boolean ok = supplyOrderPurchaseService.deleteSupplyOrder(id);
        Map<String, Object> res = new HashMap<>();
        res.put("success", ok);
