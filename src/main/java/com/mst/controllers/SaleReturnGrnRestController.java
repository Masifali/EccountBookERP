...
public class SaleReturnGrnRestController {
    ...
    public ResponseEntity<?> getById(@PathVariable("id") int id) {
        Map<String, Object> data = saleReturnGrnService.getById(id);
    ...
    public ResponseEntity<?> save(@RequestBody Map<String, Object> payload) {
        ...
        Map<String, Object> res = saleReturnGrnService.saveSaleReturnGrn(payload);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        boolean ok = saleReturnGrnService.deleteSaleReturnGrn(id);
        Map<String, Object> res = new HashMap<>();
        res.put("success", ok);
