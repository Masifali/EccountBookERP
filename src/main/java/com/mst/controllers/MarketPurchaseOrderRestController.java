...
import com.mst.services.MarketPurchaseOrderService;
...
@RestController
@RequestMapping("/api/purchase/market-purchase-order")
public class MarketPurchaseOrderRestController {

    @Autowired
    private MarketPurchaseOrderService marketPurchaseOrderService;
    ...
    public ResponseEntity<?> getDropdowns() {
        ...
        return ResponseEntity.ok(marketPurchaseOrderService.getDropdowns(orgId, compId));
    }
    ...
    public ResponseEntity<?> getNextCode() {
        ...
        int nextNo = marketPurchaseOrderService.generateNextDocNo(orgId, compId, branchId, yearId);
    ...
    public ResponseEntity<?> getHistory(@RequestBody(required = false) Map<String, Object> bodyParams,
        ...
        List<Map<String, Object>> history = marketPurchaseOrderService.getHistory(orgId, compId, branchId, yearId, fromDate, toDate, supplierId, fromDocNo, toDocNo, dateType);
        return ResponseEntity.ok(history);
    }

    @GetMapping("/{id}")
    public ResponseEntity<?> getById(@PathVariable("id") int id) {
        Map<String, Object> data = marketPurchaseOrderService.getById(id);
    ...
    public ResponseEntity<?> save(@RequestBody Map<String, Object> payload) {
        ...
        Map<String, Object> res = marketPurchaseOrderService.saveMarketPurchaseOrder(payload);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        boolean ok = marketPurchaseOrderService.deleteMarketPurchaseOrder(id);
        Map<String, Object> res = new HashMap<>();
        res.put("success", ok);
