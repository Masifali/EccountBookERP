...
public class PurchaseInvoiceAgainstGrnDirectRestController {
    ...
    @Autowired
    private PurchaseInvoiceAgainstGrnDirectService service;
    ...
    @GetMapping("/load-grn")
    public List<Map<String, Object>> loadGrnDirectForInvoice(@RequestParam String gdnIds) {
        return service.loadGrnDirectForInvoice(gdnIds);
    }

    @GetMapping("/empty-bags")
    public List<Map<String, Object>> getEmptyBagsFromGrn(@RequestParam String gdnIds, @RequestParam(required = false) Integer orderId) {
        return service.getEmptyBagsFromGrn(gdnIds, orderId);
    }
    ...
    public List<Map<String, Object>> getHistory(
        ...
        return service.getHistory(orgId, compId, docTypeId, fromDate, toDate, fromDocNo, toDocNo, supplierId);
    }
