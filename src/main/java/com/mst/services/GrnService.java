...
import com.mst.repositories.GrnRepository;
...
public class GrnService {
    ...
    public List<Map<String, Object>> getPendingGatePasses(int orgId, int compId, int docTypeId, String fromDate, String toDate) {
        return repository.getPendingGatePasses(orgId, compId, docTypeId, fromDate, toDate);
    }
    ...
    public Map<String, Object> getById(int id) {
        ...
        if (header != null) {
            ...
            result.put("message", "GRN record not found");
        }
        return result;
    }
    ...
    public Map<String, Object> deleteRecord(int id, int orgId, int compId) {
        ...
        try {
            ...
            result.put("success", true);
            result.put("message", "GRN deleted successfully");
        } catch (Exception e) {
            result.put("success", false);
            result.put("message", "Error deleting GRN: " + e.getMessage());
        }
        return result;
    }
}
