...
$(document).ready(function () {
    ...
    $(".entry_add").on("click", function () {
        ...
        $("#purchase_order_entry_table span#serial_no").each(function (index, element) {
            ...
            $(element).closest("tr").find("input[name*='.id']").attr("id", "purchaseOrderEntries" + index + ".id");
            $(element).closest("tr").find("input[name*='.id']").attr("name", "purchaseOrderEntries[" + index + "].id");


            $(element).closest("tr").find("select[name*='.itemDef']").attr("id", "purchaseOrderEntries" + index + ".itemDef");
            $(element).closest("tr").find("select[name*='.itemDef']").attr("name", "purchaseOrderEntries[" + index + "].itemDef");


            $(element).closest("tr").find("select[name*='.supplierAccount']").attr("id", "purchaseOrderEntries" + index + ".supplierAccount.code");
            $(element).closest("tr").find("select[name*='.supplierAccount']").attr("name", "purchaseOrderEntries[" + index + "].supplierAccount.code");


            $(element).closest("tr").find("select[name*='.millKhata']").attr("id", "purchaseOrderEntries" + index + ".millKhata.id");
            $(element).closest("tr").find("select[name*='.millKhata']").attr("name", "purchaseOrderEntries[" + index + "].millKhata.id");

            $(element).closest("tr").find("input[name*='.rate']").attr("id", "purchaseOrderEntries" + index + ".rate");
            $(element).closest("tr").find("input[name*='.rate']").attr("name", "purchaseOrderEntries[" + index + "].rate");

            $(element).closest("tr").find("input[name*='.kg']").attr("id", "purchaseOrderEntries" + index + ".kg");
            $(element).closest("tr").find("input[name*='.kg']").attr("name", "purchaseOrderEntries[" + index + "].kg");

            $(element).closest("tr").find("input[name*='.vehical']").attr("id", "purchaseOrderEntries" + index + ".vehical");
            $(element).closest("tr").find("input[name*='.vehical']").attr("name", "purchaseOrderEntries[" + index + "].vehical");

            $(element).closest("tr").find("input[name*='.paymentDate']").attr("id", "purchaseOrderEntries" + index + ".paymentDate");
            $(element).closest("tr").find("input[name*='.paymentDate']").attr("name", "purchaseOrderEntries[" + index + "].paymentDate");

            $(element).closest("tr").find("select[name*='.paymentType']").attr("id", "purchaseOrderEntries" + index + ".paymentType");
            $(element).closest("tr").find("select[name*='.paymentType']").attr("name", "purchaseOrderEntries[" + index + "].paymentType");
    ...
    function getNextPurchaseOrderCode() {
        ...
        $.ajax({
            ...
            url: "/payables/next_purchase_order_code",
...
//		}
//		
//		$(thisControl).closest("tr").find(".millKhataKhata").empty();
//    	$(thisControl).closest("tr").find(".millKhataKhata").append("<option>&emsp;</option>");
//    	console.log(".millKhata");
//    	
//	    $.get( "/payables/millKhata_khate?millKhataId=" + $(thisControl).val(), function( data ) {
//	        
//	        for (var i = 0, len = data.length; i < len; i++) {
//	        	var option = "<option value = " + data[i].id + ">"+ data[i].name +  "</option>";
//	        	$(thisControl).closest("tr").find(".millKhataKhata").append(option);
//	    	}
//	        
//	        //$(thisControl).closest("tr").find(".itemDef").trigger("change.select2");
//	        //$(thisControl).closest("tr").find(".itemDef").find("#inputhidden input.select2-input").trigger("input");
...
//			}
        ...
        if (millKhataEmpty) {
            $.confirm({
                title: "ENCOUNTERED AN ERROR!",
                content: "PLEASE SELECT MILLKATA FOR EACH ROW",
                type: 'red',
                typeAnimated: true,
            });
            // Prevent the form from submitting via the browser.
