            ...
            success: function (data) {
                ...
                $.each(data, function (i, tBEntry) {
                    ...
                    tableName.row.add([
                        tBEntry.partyCode,
                        tBEntry.partyName,
                        parseFloat(tBEntry.openBalance) * -1,
                        tBEntry.purchases,
                        tBEntry.oDuePayments,
                        tBEntry.perMonth,
                        tBEntry.avgPerMonth,
                        tBEntry.avgPerDay,
                        tBEntry.todayPayment,
                        tBEntry.weekPayment,
                        tBEntry.monthPayment,
                        tBEntry.differenceWeek,
                        parseFloat(tBEntry.differencePercentage) * -1,
                        tBEntry.differenceMonth,
                        parseFloat(tBEntry.differenceMonthPercentage) * -1,
                        parseFloat(tBEntry.paymentRequiredPerDay) * -1,
                        parseFloat(tBEntry.paymentRequiredPerWeek) * -1,
                        parseFloat(tBEntry.closingBalance) * -1,
                        tBEntry.closingDueBalance,
                        tBEntry.cashVouchers,
                        tBEntry.ojVouchers,
                        tBEntry.jvVouchers,
                        tBEntry.bpvVouchers,
                        tBEntry.jvAdjusted,
