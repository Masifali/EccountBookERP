 ...
 */
    ...
    $("#sjvVoucher\\.itemStock\\.account\\.code").on("change", function () {
        ...
        $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleRate").val(parseFloat(0));
    ...
    $("#pjvVoucher\\.itemStock\\.account\\.code").on("change", function () {
        ...
        $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseRate").val(parseFloat(0));
        getPendingPurchaseOrderList();
        pjcalculateTotal();
    });
    ...
    $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseRate").on("input", function () {
        pjcalculateTotal();
    });
    ...
    $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleRate").on("input", function () {
        calculateTotal();
    });
    ...
    $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleOrderEntry").on("change", function () {
        ...
        $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleRate").val(parseFloat(arr[2].trim()));
        calculateTotal();
    ...
    $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseOrderEntry").on("change", function () {
        ...
        var arr = selectedText.split('/');
        $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseRate").val(parseFloat(arr[2].trim()));
        pjcalculateTotal();
    ...
    function getPendingPurchaseOrderList() {
        var id = $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseOrderEntry").val();
        // PREPARE FORM DATA
        var formData = {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseOrderEntry").val(id);
            },
            complete: function () {
    ...
    function getPendingSaleOrderList() {
        ...
        var entryID = $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleOrderEntry").val();
        var formData = {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // this id  which Entry is saved in voucher beacuse on load page empty the dropdown
                $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleOrderEntry").val(entryID);
            },
            complete: function () {
                // enable submit button
            },
    ...
    function calculateTotal() {
        ...
        saleRate = $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.saleRate").val();
        ...
        invoiceAmountTotal = qtyInMan * saleRate;

        var int_part = Math.trunc(qtyInMan); // returns 3
        var float_part = Number((qtyInMan - int_part).toFixed(2));

        $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.manWithKg").val(int_part + "- " + (float_part * 40).toFixed(0));
        ...
        $("#sjvVoucher\\.itemStock\\.itemStockEntries0\\.amount").val(formatter.format(invoiceAmountTotal));

        $("#sjvVoucher\\.itemStock\\.bankTaxAmount").val(formatterNoFloat.format(invoiceAmountTotal * bankTaxRate / 100));

        $("#sjvVoucher\\.itemStock\\.millTaxAmount").val(formatterNoFloat.format(qtyInMan * millTaxRate));
        ...
        $("#sjvVoucher_entry_table tbody tr:eq(3) td:eq(5) input").val(0);
    ...
    function pjcalculateTotal() {
        ...
        // SALES VOUCHER CALCULATIONS
        purchaseRate = $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.purchaseRate").val();
        ...
        invoiceAmountTotal = qtyInMan * purchaseRate;

        var int_part = Math.trunc(qtyInMan); // returns 3
        var float_part = Number((qtyInMan - int_part).toFixed(2));

        $("#pjvVoucher\\.itemStock\\.itemStockEntries0\\.manWithKg").val(int_part + "- " + (float_part * 40).toFixed(0));
        //console.log("a   "+int_part+"-"+(float_part*40));
        ...
        $("#pjvVoucher_entry_table tbody tr:eq(6) td:eq(5) input").val(0);
        $("#pjvVoucher_entry_table tbody tr:eq(7) td:eq(4) input").val(otherExp.replace(/[^0-9\.-]+/g, ""));
