    	...
    	var table = $('#tb_report_datatable').DataTable({
	        ...
	        buttons: [
	            ...
	            },*/
	            {
	                ...
	                title: 'P&L REPORT' + ' (' + getFormattedDate(new Date()) + ", " + new Date().toLocaleString().split(",")[1].trim() + ')',
	                footer: true,
		    		...
		    		if ($("#level").val() > 1){
		    			$.each(tBEntry.children, function (j, secondLevel) {
		    				...
		    				table.row.add([
		                        ...
		                        formatter.format(secondLevel[7]),
		                        formatter.format(secondLevel[8]),
		                        formatter.format(secondLevel[9]),
		                        formatter.format(secondLevel[10]),
		                        formatter.format(secondLevel[11]),
		                        formatter.format(secondLevel[12]),
		                        formatter.format(secondLevel[1]),
		                        formatter.format(secondLevel[2]),
		                        formatter.format(secondLevel[3]),
		                        formatter.format(secondLevel[4]),
		                        formatter.format(secondLevel[5]),
		                        formatter.format(secondLevel[6]),
				    		...
				    		if ($("#level").val() > 2){
				    			$.each(secondLevel.children, function (k, thirdLevel) {
				    				...
				    				table.row.add([
				                        ...
				                        formatter.format(thirdLevel[7]),
				                        formatter.format(thirdLevel[8]),
				                        formatter.format(thirdLevel[9]),
				                        formatter.format(thirdLevel[10]),
				                        formatter.format(thirdLevel[11]),
				                        formatter.format(thirdLevel[12]),
				                        formatter.format(thirdLevel[1]),
				                        formatter.format(thirdLevel[2]),
				                        formatter.format(thirdLevel[3]),
				                        formatter.format(thirdLevel[4]),
				                        formatter.format(thirdLevel[5]),
				                        formatter.format(thirdLevel[6]),
						    		...
						    		if ($("#level").val() > 3){
						    			$.each(thirdLevel.children, function (l, fourthLevel) {
								    		...
								    		table.row.add([
						                        ...
						                        formatter.format(fourthLevel[7]),
						                        formatter.format(fourthLevel[8]),
						                        formatter.format(fourthLevel[9]),
						                        formatter.format(fourthLevel[10]),
						                        formatter.format(fourthLevel[11]),
						                        formatter.format(fourthLevel[12]),
						                        formatter.format(fourthLevel[1]),
						                        formatter.format(fourthLevel[2]),
						                        formatter.format(fourthLevel[3]),
						                        formatter.format(fourthLevel[4]),
						                        formatter.format(fourthLevel[5]),
						                        formatter.format(fourthLevel[6]),
