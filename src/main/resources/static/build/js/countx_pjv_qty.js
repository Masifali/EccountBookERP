...
$(document).ready(function () {
    ...
    $("#bagBarti").on("change", function () {

        $("#itemStock\\.itemStockEntries0\\.bags").val(($("#itemStock\\.itemStockEntries0\\.totalKg").val() / $("#bagBarti").val()).toFixed(1));
        calculateTotal();
    });
    ...
    function loadItemDefDetail(thisControl) {
        ...
        $.get("/payables/item_def_detail?itemDefId=" + $(thisControl).val() + "&companyId=" + 1 + "&branchId=" + $("#branch").val() + "&voucherStatusId=" + "0", function (data) {
            ...
            $("#deductionPercent").val(data.deductionPercent);
            $("#kantaVibration").val(data.kantaVibration);
...
//	$("#itemStock\\.itemStockEntries0\\.totalKatoti").on("input", function () {
    ...
    $("#itemStock\\.itemStockEntries0\\.totalKg").on("input", function () {
        $("#itemStock\\.itemStockEntries0\\.totalKatoti").val($("#itemStock\\.itemStockEntries0\\.totalKg").val() * $("#deductionPercent").val() / 100);
        $("#itemStock\\.itemStockEntries0\\.katoti").val($("#itemStock\\.itemStockEntries0\\.totalKatoti").val() / $("#itemStock\\.itemStockEntries0\\.bags").val())
        calculateTotal();
    });
...
//	});
    ...
    function generateTabIndexing() {
        ...
        $("#juteBag ").attr('tabindex', 23);
        $("#juteBagRate").attr('tabindex', 24);
        $("#plasticBag").attr('tabindex', 25);
        $("#plasticBagRate").attr('tabindex', 26);
        $("#rem").attr('tabindex', 27);
        $("#brokerAccount").attr('tabindex', 28);


        $("#itemStock\\.brokriRate").attr('tabindex', 29)
        $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry").attr('tabindex', 30)
    ...
    function calculateTotal() {
        ...
        purchaseAmount = $("#itemStock\\.itemStockEntries0\\.amount").val();
        ...
        totalDeduction = (bags * deduction).toFixed(1);
        if ($("#kantaVibration").val() === "true") {
            $("#itemStock\\.itemStockEntries0\\.totalKatoti").val((totalKg / 40) * (0.1));
            totalDeduction = $("#itemStock\\.itemStockEntries0\\.totalKatoti").val();
            $("#itemStock\\.itemStockEntries0\\.katoti").val($("#itemStock\\.itemStockEntries0\\.totalKatoti").val() / $("#itemStock\\.itemStockEntries0\\.bags").val());
        }
        ...
        var float_part = Number((qtyInMan - int_part).toFixed(10));
        ...
        console.log("other Exp:" + formatterNoFloat.format(otherExp).replace(/[^0-9\.-]+/g, ""))
        ...
        ////
        debitCharges = debitCharges + parseFloat(gisahi);
        ...
        console.log(purchaseAmount.replace(/[^0-9\.-]+/g, ""));
        $("#itemStock\\.netAmount").val(formatter.format(purchaseAmount.replace(/[^0-9\.-]+/g, "") - creditCharges + debitCharges));

        $("#voucher_entry_table tbody tr:eq(0) td:eq(5) input").val(purchaseAmount.replace(/[^0-9\.-]+/g, "") - creditCharges + debitCharges);
        $("#voucher_entry_table tbody tr:eq(1) td:eq(4) input").val(purchaseAmount.replace(/[^0-9\.-]+/g, ""));

        $("#voucher_entry_table tbody tr:eq(2) td:eq(4) input").val(unloadingAmount.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(2) td:eq(5) input").val(0);
        $("#voucher_entry_table tbody tr:eq(3) td:eq(5) input").val(freightCharges.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(3) td:eq(4) input").val(0);
        $("#voucher_entry_table tbody tr:eq(4) td:eq(5) input").val(millTaxAmount.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(4) td:eq(4) input").val(0);
        $("#voucher_entry_table tbody tr:eq(5) td:eq(5) input").val(bankTaxAmount.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(5) td:eq(4) input").val(0);
        $("#voucher_entry_table tbody tr:eq(6) td:eq(4) input").val(silaiAmount.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(6) td:eq(5) input").val(0);
        /*$("#voucher_entry_table tbody tr:eq(7) td:eq(4) input").val(otherExp.replace(/[^0-9\.-]+/g, ""));
        ...
        $("#voucher_entry_table tbody tr:eq(8) td:eq(4) input").val(bardanaAmount.replace(/[^0-9\.-]+/g, ""));
        $("#voucher_entry_table tbody tr:eq(8) td:eq(5) input").val(0);
...
//		if(parseFloat(bankTaxAmount.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			$("#voucher_entry_table tbody tr:eq(2) td:eq(5) input").val(bankTaxAmount.replace(/[^0-9\.-]+/g, ""));
//			
//			$("#voucher_entry_table tbody tr:eq(2) td:eq(4) input").val(0);
//		}
//		else
//		{
//			$("#voucher_entry_table tbody tr:eq(2) td:eq(4) input").val(bankTaxAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(2) td:eq(5) input").val(0);
//		}
//		if(parseFloat(freightCharges.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			
//			$("#voucher_entry_table tbody tr:eq(3) td:eq(4) input").val(0);
//		}else{
...
//		}
//		if(parseFloat(millTaxAmount.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			$("#voucher_entry_table tbody tr:eq(4) td:eq(5) input").val(millTaxAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(4) td:eq(4) input").val(0);
//		}else{
...
//		}
//		if(parseFloat(bardanaAmount.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			$("#voucher_entry_table tbody tr:eq(5) td:eq(5) input").val(bardanaAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(5) td:eq(4) input").val(0);
//		}else{
//			$("#voucher_entry_table tbody tr:eq(5) td:eq(4) input").val(bardanaAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(5) td:eq(5) input").val(0);
//		}
//		if(parseFloat(silaiAmount.replace(/[^0-9\.-]+/g, ""))>0)
//		{
...
//			$("#voucher_entry_table tbody tr:eq(6) td:eq(5) input").val(0);
//		}
//		if(parseFloat(unloadingAmount.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			$("#voucher_entry_table tbody tr:eq(7) td:eq(5) input").val(unloadingAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(7) td:eq(4) input").val(0);
//		}else{
//			$("#voucher_entry_table tbody tr:eq(7) td:eq(4) input").val(unloadingAmount.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(7) td:eq(5) input").val(0);
//		}
//		if(parseFloat(otherExp.replace(/[^0-9\.-]+/g, ""))>0)
//		{
//			$("#voucher_entry_table tbody tr:eq(8) td:eq(5) input").val(otherExp.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(8) td:eq(4) input").val(0);
//		}else{
//			$("#voucher_entry_table tbody tr:eq(8) td:eq(4) input").val(otherExp.replace(/[^0-9\.-]+/g, ""));
//			$("#voucher_entry_table tbody tr:eq(8) td:eq(5) input").val(0);
//		}
    ...
    $(document).keydown(function (e) {
        ...
        function enterKey() {
            ...
            if (key == 13 && !e.shiftKey) { //If enter key
                ...
                getFocusBookNumber = 0;	// this use to remove default fuscus of selected class
    ...
    function getPendingPurchaseOrderList() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry").empty();
                $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry").append("<option></option>");
                ...
                for (var i = 0, len = data.length; i < len; i++) {
                    ...
                    $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry").append(option);
                }
//					
            },
            complete: function () {
    ...
    $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry").on("change", function () {
        var selectedText = $("#itemStock\\.itemStockEntries0\\.purchaseOrderEntry option:selected").text();
