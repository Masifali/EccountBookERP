    ...
    $(document).keydown(function (e) {
        ...
        if ($("#editVoucher").val() === "true") {
            if (e.altKey && e.keyCode == 67)//c
            {
                ...
                location.href = location.protocol + "//" + location.host + "/purchase_journal_vouchers/edit/" + $("#voucher_id").val();
            }
        }
        if ($("#newPurchaseVoucher").val() === "true") {
            if (e.altKey && e.keyCode == 78)// n
            {
                location.href = location.protocol + "//" + location.host + "/payable/new_pjv_qty_form";
                //$("#edit_voucher").click();
            }
        }
    });
