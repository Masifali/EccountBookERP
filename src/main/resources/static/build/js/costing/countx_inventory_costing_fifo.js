			...
			success:function(data){
				...
				$.each(data, function (i, breakDown) {
					...
					table.row.add([
						...
						breakDown.saleVoucherId ? "<a style='text-decoration: underline;' target=_blank href="+location.protocol + "//" + location.host+"/sale_journal_vouchers/"+breakDown.saleVoucherId+">"+breakDown.saleVoucherCode+"</a>" : "",
						...
						formatter.format(breakDown.purchasePrice),
						//  breakDown.purchaseTotalWeight,
						formatter.format(breakDown.purchaseAmount),
						formatterWithNotFloat.format(breakDown.saleAmount-breakDown.purchaseAmount),
					]);
				});
