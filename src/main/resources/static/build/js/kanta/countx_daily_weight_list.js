$(document).ready(function () {
    ...
    // UPDATE WEIGHT ENTRY
     $('body').on('click', '.weight_entry_edit', function ()  {
        ...
        $("#updateEntryForm #maschar").val($(this).closest("tr").find(".maschar").val() );
        $("#updateEntryForm #unload").val($(this).closest("tr").find(".unload").val() );
        $("#updateEntryForm #boy").val($(this).closest("tr").find(".boy").val());
            ...
            success: function (data) {
                ...
                $.each(data, function (i, weightEntry) {
                    ...
                    voucherTable.row.add([
                      ...
                      /*   '<input type= "hidden" class ="sukai" value=' + weightEntry.sukai + '><input type= "hidden" class ="location" value=' + weightEntry.location + '><input type= "hidden" class ="maschar" value=' + weightEntry.maschar + '><input type= "hidden" class ="id" value=' + weightEntry.id + '> <input type= "hidden" class ="boy" value=' + weightEntry.boy + '> <input type= "hidden" class ="millId" value=' + weightEntry.unload + '><a class="weight_entry_edit" style="text-decoration: underline;color:green" href="javascript:void(0)">EDIT</a>'*/
