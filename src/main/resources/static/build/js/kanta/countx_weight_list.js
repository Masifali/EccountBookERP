...
//    	  	        destroy: true,
            ...
            buttons: [
                ...
                {
                    extend: 'pdfHtml5',
                    title: 'WEIGHT LIST' + ' (' + getFormattedDate(new Date()) + ", " + new Date().toLocaleString().split(",")[1].trim() + ')',
            ...
            success: function (data) {
                ...
                $.each(data, function (i, weightEntry) {
                    ...
                    voucherTable.row.add([
                        ...
                        getFormattedDate(new Date(weightEntry.createdAt)) + ", " + new Date(weightEntry.createdAt).toLocaleString().split(",")[1].trim(),

                        weightEntry.vehicalNo,
                        weightEntry.autioWeight,
                        weightEntry.manualWeight,
                        weightEntry.amount,
                        weightEntry.remarks,
