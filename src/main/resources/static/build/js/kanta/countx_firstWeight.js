...
function downloadWeightPrint() {
    // $.get("/kanta/downlaodWeight/?weightId=" + $("#id").val(),function (response){
    //     // alert('got response'+response);
    //     // window.open(response);
    //     var blob=new Blob([response]);
    //     var link=document.createElement('a');
    //     link.href=window.URL.createObjectURL(blob);
    //     link.download="Weight.pdf";
    //     link.click();
    // });
    window.open("/kanta/downlaodWeight/?weightId=" + $("#id").val(), '_blank');
    // location.replace("/kanta/downlaodWeight/?weightId=" + $("#id").val());
