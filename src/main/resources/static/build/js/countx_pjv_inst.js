...
//	});
	...
	function calculateTotal(){
		...
		var unloadingCharges = parseFloat(($("#tax_table tbody tr:eq(0) #itemStock\\.unloadingRate").val() * itemTotalQty).toFixed(1));
		unloadingCharges = unloadingCharges.toFixed(0);
		$("#tax_table tbody tr:eq(0) th:eq(2)").text(unloadingCharges);
		...
		var netAmount =  - freightChargesCredit  +invoiceAmountTotal +freightCharges-barDanaCreditAmount;
		...
		$("#voucher_entry_table tbody tr:eq(0) td:eq(5) input").val(parseFloat((amountWithSalesTax + bardanaDebitAmount).toFixed(2)));
		$("#voucher_entry_table tbody tr:eq(1) td:eq(4) input").val(invoiceAmountTotal +discount_total_amount+unloadingCharges);
		$("#voucher_entry_table tbody tr:eq(2) td:eq(5) input").val(unloadingCharges);
		
		$("#voucher_entry_table tbody tr:eq(3) td:eq(4) input").val(freightCharges);
		$("#voucher_entry_table tbody tr:eq(3) td:eq(5) input").val(freightChargesCredit);
		...
		$("#voucher_entry_table tbody tr:eq(6) td:eq(4) input").val(bardanaDebitAmount);
		$("#voucher_entry_table tbody tr:eq(6) td:eq(5) input").val(barDanaCreditAmount+discount_total_amount);
